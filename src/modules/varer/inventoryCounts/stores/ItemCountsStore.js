...
export default Store({
  ...
  initialize() {
    this.on(
      actionTypes.RECEIVE_INVENTORYCOUNTCOUNTS_START,
      (state, { inventoryCountId }) => {
        return state
    ...
    this.on(
      actionTypes.RECEIVE_INVENTORYCOUNTCOUNTS_SUCCESS,
      (state, { response, inventoryCountId }) => {
    ...
    this.on(
      actionTypes.RECEIVE_INVENTORYCOUNTCOUNTS_FAILURE,
      (state, { error }) => {
